        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-1 overflow-x-auto pb-1 max-w-full">
              {(['all', 'super_admin', 'developer', 'admin', 'operations', 'finance', 'support', 'merchant', 'driver', 'customer'] as const).map((r) => (
                <button
                  key={r}
              ...
              <tbody className="divide-y divide-white/5 font-mono">
                {ALL_SYSTEM_PERMISSIONS.map((perm) => (
                  <tr key={perm.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    {(['super_admin', 'developer', 'admin', 'operations', 'finance', 'support', 'merchant', 'driver', 'customer'] as const).map((r) => {
